...
(function() {
    ...
    const modifiedScriptURL = "https://cdn.jsdelivr.net/gh/sys512/w0rdwall/public-v0.js";
    ...
    window.addEventListener('load', function() {
        ...
        if (topRightPanels) {
            ...
            if (inputsWrapper) {
                console.log("Inputs-Wrapper div found, attempting injection");
                const targetPanel = document.querySelector('.col.join-game');
                injectHTML(targetPanel);
            }
        }
    });
